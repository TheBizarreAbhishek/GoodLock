...
.field public static final LAND_HEIGHT_PERCENT:F = 0.3f

.field public static final MAX_FONT_SCALE:F = 1.0f

.field public static final TAG:Ljava/lang/String; = "Sesl_CTL"
...
.field public mCustomSubTitleView:Landroid/view/View;

.field public mDefaultHeight:F

.field public mExtendSubTitleAppearance:I

.field public mExtendTitleAppearance:I

.field public mExtendedSubTitle:Landroid/widget/TextView;

.field public mExtendedTitle:Landroid/widget/TextView;

.field public mFadeToolbarTitle:Z

.field public mHeightProportion:F

.field public mIsCollapsingToolbarTitleCustom:Z

.field public mIsCustomAccessibility:Z

.field public mSubTitleEnabled:Z

.field public mTitleEnabled:Z

.field public mTitleLayout:Landroid/widget/LinearLayout;

.field public mTitleLayoutParent:Landroid/widget/LinearLayout;

.field public mViewStubCompat:Landroidx/appcompat/widget/ViewStubCompat;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mIsCustomAccessibility:Z

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mCustomSubTitleView:Landroid/view/View;
    ...
    sget v4, Lcom/google/android/material/R$styleable;->CollapsingToolbarLayout_extendedTitleEnabled:I

    invoke-virtual {v3, v4, p1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v4

    iput-boolean v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mTitleEnabled:Z
    ...
    invoke-virtual {v2, v4}, Lcom/google/android/material/internal/CollapsingTextHelper;->setTextSizeInterpolator(Landroid/animation/TimeInterpolator;)V
    ...
    invoke-virtual {v2, v1}, Lcom/google/android/material/internal/CollapsingTextHelper;->setRtlTextDirectionHeuristicsEnabled(Z)V
    ...
    invoke-virtual {v2, v4}, Lcom/google/android/material/internal/CollapsingTextHelper;->setExpandedTextGravity(I)V
    ...
    :cond_2
    sget v2, Lcom/google/android/material/R$styleable;->CollapsingToolbarLayout_subtitle:I

    invoke-virtual {v3, v2}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v2

    iget-boolean v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mTitleEnabled:Z
    ...
    :goto_1
    iput-boolean v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mSubTitleEnabled:Z

    new-instance v4, Landroid/widget/LinearLayout;

    invoke-direct {v4, v9, p2, p3}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mTitleLayoutParent:Landroid/widget/LinearLayout;

    sget v5, Lcom/google/android/material/R$id;->collapsing_appbar_title_layout_parent:I
    ...
    iget-object v6, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mTitleLayoutParent:Landroid/widget/LinearLayout;

    invoke-virtual {p0, v6, v4}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-object v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mTitleLayout:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {p3, v1, v1, v1, p2}, Landroid/widget/LinearLayout;->setPadding(IIII)V
    ...
    invoke-direct {p2, v0, p3, v4}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
    ...
    iget-object v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mTitleLayout:Landroid/widget/LinearLayout;

    invoke-virtual {p3, v4, p2}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->mExtendTitleAppearance:I
    ...
    invoke-virtual {p0, v2}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->seslSetSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, p3, v1}, Landroid/content/res/TypedArray;->getResourceId(II)I
    ...
    invoke-virtual {v3, p2, v0}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-virtual {v3, p3, p1}, Landroid/content/res/TypedArray;->getInt(II)I
...
.method public static synthetic access$100(Lcom/google/android/material/appbar/CollapsingToolbarLayout;)Landroid/widget/LinearLayout;
    .locals 0
...
.method private updateCollapsedBounds(Z)V
    ...
    invoke-virtual {v5, v6, v8, v4, p1}, Lcom/google/android/material/internal/CollapsingTextHelper;->setCollapsedBounds(IIII)V
