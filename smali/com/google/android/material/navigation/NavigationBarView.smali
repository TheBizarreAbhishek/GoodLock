...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    new-instance p3, Lcom/google/android/material/navigation/NavigationBarPresenter;

    invoke-direct {p3, p1}, Lcom/google/android/material/navigation/NavigationBarPresenter;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lcom/google/android/material/navigation/NavigationBarView;->presenter:Lcom/google/android/material/navigation/NavigationBarPresenter;

    invoke-virtual {p0}, Lcom/google/android/material/navigation/NavigationBarView;->getMaxItemCount()I

    move-result p3

    iput p3, p0, Lcom/google/android/material/navigation/NavigationBarView;->mMaxItemCount:I

    invoke-virtual {p0, p3}, Lcom/google/android/material/navigation/NavigationBarView;->setMaxItemCount(I)V
    ...
    sget p3, Lcom/google/android/material/R$styleable;->NavigationBarView_seslViewType:I

    invoke-virtual {p2, p3, v6}, Landroidx/appcompat/widget/TintTypedArray;->getInteger(II)I

    move-result p3

    invoke-virtual {p0, p3}, Lcom/google/android/material/navigation/NavigationBarView;->seslSetViewType(I)V
    ...
    invoke-virtual {p4, v0}, Lcom/google/android/material/navigation/NavigationBarPresenter;->setMenuView(Lcom/google/android/material/navigation/NavigationBarMenuView;)V

    iget-object p4, p0, Lcom/google/android/material/navigation/NavigationBarView;->presenter:Lcom/google/android/material/navigation/NavigationBarPresenter;

    invoke-virtual {p4, v8}, Lcom/google/android/material/navigation/NavigationBarPresenter;->setId(I)V
    ...
    invoke-virtual {p4, v0, v1}, Lcom/google/android/material/navigation/NavigationBarPresenter;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    :goto_0
    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_itemIconSize:I

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, Lcom/google/android/material/R$dimen;->sesl_navigation_bar_icon_size:I
    ...
    invoke-virtual {p0, p4}, Lcom/google/android/material/navigation/NavigationBarView;->setItemIconSize(I)V

    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_itemTextAppearanceInactive:I
    ...
    invoke-virtual {p2, p4, v7}, Landroidx/appcompat/widget/TintTypedArray;->getResourceId(II)I

    move-result p4

    invoke-virtual {p0, p4}, Lcom/google/android/material/navigation/NavigationBarView;->setItemTextAppearanceInactive(I)V

    :cond_1
    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_seslLabelTextAppearance:I
    ...
    invoke-virtual {p0, p4}, Lcom/google/android/material/navigation/NavigationBarView;->seslSetLabelTextAppearance(I)V

    :cond_2
    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_itemTextAppearanceActive:I
    ...
    invoke-virtual {p0, p4}, Lcom/google/android/material/navigation/NavigationBarView;->setItemTextAppearanceActive(I)V

    :cond_3
    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_itemTextColor:I
    ...
    invoke-virtual {p0, p4}, Lcom/google/android/material/navigation/NavigationBarView;->setItemTextColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p4}, Lcom/google/android/material/navigation/NavigationBarMenuView;->setBackgroundColorDrawable(Landroid/graphics/drawable/ColorDrawable;)V
    ...
    instance-of p4, p4, Landroid/graphics/drawable/ColorDrawable;
    ...
    invoke-static {p0, p4}, Landroidx/core/view/ViewCompat;->setBackground(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    :cond_7
    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_elevation:I
    ...
    invoke-virtual {p2, p4, v7}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result p4

    int-to-float p4, p4

    invoke-virtual {p0, p4}, Lcom/google/android/material/navigation/NavigationBarView;->setElevation(F)V

    :cond_8
    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_backgroundTint:I

    invoke-static {p1, p2, p4}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v0, p4}, Landroidx/core/graphics/drawable/DrawableCompat;->setTintList(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_labelVisibilityMode:I

    const/4 v0, -0x1

    invoke-virtual {p2, p4, v0}, Landroidx/appcompat/widget/TintTypedArray;->getInteger(II)I

    move-result p4

    invoke-virtual {p0, p4}, Lcom/google/android/material/navigation/NavigationBarView;->setLabelVisibilityMode(I)V

    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_itemBackground:I
    ...
    invoke-virtual {p1, p4}, Lcom/google/android/material/navigation/NavigationBarMenuView;->setItemBackgroundRes(I)V

    goto :goto_1

    :cond_9
    sget p4, Lcom/google/android/material/R$styleable;->NavigationBarView_itemRippleColor:I
    ...
    iget-object p2, p0, Lcom/google/android/material/navigation/NavigationBarView;->mSelectedCallback:Landroidx/appcompat/view/menu/MenuBuilder$Callback;
    ...
    invoke-virtual {p1, p2}, Lcom/google/android/material/navigation/NavigationBarMenuView;->setOverflowSelectedCallback(Landroidx/appcompat/view/menu/MenuBuilder$Callback;)V

    iget-object p1, p0, Lcom/google/android/material/navigation/NavigationBarView;->menuView:Lcom/google/android/material/navigation/NavigationBarMenuView;

    invoke-virtual {p1}, Lcom/google/android/material/navigation/NavigationBarMenuView;->getVisibleItemCount()I
