.class public final Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;
...
.method public constructor <init>(Lcom/samsung/android/goodlock/terrace/TerraceFragment;Lcom/samsung/android/goodlock/terrace/HttpClient$RequestUrl;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;->this$0:Lcom/samsung/android/goodlock/terrace/TerraceFragment;
    ...
    iput-wide p1, p0, Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;->currentTime:J

    return-void
.end method

.method public static final bindItem$lambda-3$lambda-2(Lcom/samsung/android/goodlock/terrace/TerraceFragment;Lcom/samsung/android/goodlock/terrace/dto/Progress;Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;Lcom/samsung/android/goodlock/terrace/TerraceFragment$PostAdapter$ItemHolder;Landroid/view/View;)V
    .locals 2
    ...
    invoke-static {p0, v0, v1}, Lcom/samsung/android/goodlock/terrace/TerraceFragment;->access$launchProgressDetailActivity(Lcom/samsung/android/goodlock/terrace/TerraceFragment;J)V
...
# virtual methods
.method public bindItem(Lcom/samsung/android/goodlock/terrace/TerraceFragment$PostAdapter$ItemHolder;Lcom/samsung/android/goodlock/terrace/dto/Progress;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2}, Lcom/samsung/android/goodlock/terrace/dto/Progress;->getCreatedAt()Ljava/lang/String;
    ...
    iget-wide v3, p0, Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;->currentTime:J
    ...
    :goto_0
    iget-object v4, p0, Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;->this$0:Lcom/samsung/android/goodlock/terrace/TerraceFragment;
    ...
    invoke-virtual {p2}, Lcom/samsung/android/goodlock/terrace/dto/Progress;->getProduct()Ljava/lang/String;
    ...
    invoke-virtual {v5, v6}, Lcom/samsung/android/goodlock/terrace/TerraceUtil;->convertUTCTimeStampToLocalSimple(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v6}, Lcom/samsung/android/goodlock/terrace/ProgressState$Companion;->infoOf(Ljava/lang/String;)Lcom/samsung/android/goodlock/terrace/ProgressState$Info;
    ...
    invoke-virtual {v2}, Lcom/samsung/android/goodlock/terrace/ProgressState$Info;->getStrId()I
    ...
    invoke-virtual {p2}, Lcom/samsung/android/goodlock/terrace/dto/Progress;->getTitle()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lcom/samsung/android/goodlock/terrace/dto/Progress;->getPin()Z
    ...
    new-instance v1, Lc/d/a/a/a0/x1;

    invoke-direct {v1, v4, p2, p0, p1}, Lc/d/a/a/a0/x1;-><init>(Lcom/samsung/android/goodlock/terrace/TerraceFragment;Lcom/samsung/android/goodlock/terrace/dto/Progress;Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;Lcom/samsung/android/goodlock/terrace/TerraceFragment$PostAdapter$ItemHolder;)V
...
.method public bridge synthetic bindItem(Lcom/samsung/android/goodlock/terrace/TerraceFragment$PostAdapter$ItemHolder;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;->bindItem(Lcom/samsung/android/goodlock/terrace/TerraceFragment$PostAdapter$ItemHolder;Lcom/samsung/android/goodlock/terrace/dto/Progress;)V
...
.method public final getCurrentTime()J
    ...
    iget-wide v0, p0, Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter;->currentTime:J
...
.method public parse(Ljava/io/InputStreamReader;)Lcom/samsung/android/goodlock/terrace/dto/Pages;
    ...
    new-instance v1, Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter$parse$1;

    invoke-direct {v1}, Lcom/samsung/android/goodlock/terrace/TerraceFragment$ProgressAdapter$parse$1;-><init>()V
