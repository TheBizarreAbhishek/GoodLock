.class public final Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$Companion;
    }
.end annotation


# static fields
.field public static final Companion:Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$Companion;
...
.field public tip:Lcom/samsung/android/goodlock/terrace/dto/Tip;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$Companion;-><init>(Lg/u/d/g;)V

    sput-object v0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->Companion:Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$Companion;
...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->id:J

    new-instance v0, Lc/c/b/e;

    invoke-direct {v0}, Lc/c/b/e;-><init>()V

    iput-object v0, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->gson:Lc/c/b/e;
    ...
    iput-object v0, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->clickChecker:Lcom/samsung/android/goodlock/terrace/ClickChecker;

    return-void
.end method

.method private final getTipById()V
    .locals 4
    ...
    iget-wide v2, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->id:J

    invoke-virtual {v1, v2, v3}, Lcom/samsung/android/goodlock/terrace/TerraceAPIUrl;->getTipById(J)Lcom/samsung/android/goodlock/terrace/HttpClient$RequestUrl;

    move-result-object v1

    new-instance v2, Lc/d/a/a/a0/l2;

    invoke-direct {v2, p0}, Lc/d/a/a/a0/l2;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
...
.method public static final getTipById$lambda-3(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;Ljava/lang/Integer;Ljava/io/InputStream;)V
    .locals 7
    ...
    new-instance v4, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$getTipById$1$2;

    const/4 p1, 0x0

    invoke-direct {v4, p0, p1}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$getTipById$1$2;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;Lg/r/d;)V
    ...
    new-instance v1, Lc/d/a/a/a0/s0;

    invoke-direct {v1, p0}, Lc/d/a/a/a0/s0;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
    ...
    const-class p2, Lcom/samsung/android/goodlock/terrace/dto/Tip;

    invoke-virtual {p1, v0, p2}, Lc/c/b/e;->i(Ljava/io/Reader;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    const-string p2, "Gson().fromJson(InputStr\u2026UTF-8\"), Tip::class.java)"
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->setTip(Lcom/samsung/android/goodlock/terrace/dto/Tip;)V

    invoke-virtual {p0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->getTip()Lcom/samsung/android/goodlock/terrace/dto/Tip;

    move-result-object p1

    invoke-static {p1}, Lcom/samsung/android/goodlock/terrace/Log;->debug(Ljava/lang/Object;)I

    new-instance p1, Lc/d/a/a/a0/o;

    invoke-direct {p1, p0}, Lc/d/a/a/a0/o;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
...
.method public static final getTipById$lambda-3$lambda-1(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
    .locals 1
    ...
    invoke-direct {p0, v0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->updateUI(Lcom/samsung/android/goodlock/terrace/dto/Tip;)V

    return-void
.end method

.method public static final getTipById$lambda-3$lambda-2(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-direct {p0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->getTipById()V
...
.method private final handleEmoticon(Ljava/lang/String;J)V
    ...
    iget-object p1, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->clickChecker:Lcom/samsung/android/goodlock/terrace/ClickChecker;
    ...
    new-instance p2, Lc/d/a/a/a0/p2;

    invoke-direct {p2, p0}, Lc/d/a/a/a0/p2;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
    ...
    invoke-direct {p0, p2, p3, v0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->postEmoticon(JLcom/samsung/android/goodlock/terrace/dto/EmoticonRequest;)V

    :goto_0
    return-void
.end method

.method public static final handleEmoticon$lambda-5(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-virtual {p0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->getClickChecker()Lcom/samsung/android/goodlock/terrace/ClickChecker;
...
.method public static final onCreate$lambda-0(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;Ljava/lang/String;)V
    .locals 0
...
.method private final postEmoticon(JLcom/samsung/android/goodlock/terrace/dto/EmoticonRequest;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->clickChecker:Lcom/samsung/android/goodlock/terrace/ClickChecker;
    ...
    new-instance v3, Lc/d/a/a/a0/g2;

    invoke-direct {v3, p0, p3, p1, p2}, Lc/d/a/a/a0/g2;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;Lcom/samsung/android/goodlock/terrace/dto/EmoticonRequest;J)V
...
.method public static final postEmoticon$lambda-12(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;Lcom/samsung/android/goodlock/terrace/dto/EmoticonRequest;JLjava/lang/Integer;Ljava/io/InputStream;)V
    .locals 4
    ...
    invoke-virtual {p3}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getMyEmoticons()Ljava/util/ArrayList;
    ...
    invoke-virtual {p3}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getEmoticonList()Ljava/util/ArrayList;
    ...
    :goto_1
    new-instance p1, Lc/d/a/a/a0/k1;

    invoke-direct {p1, p2, p0}, Lc/d/a/a/a0/k1;-><init>(Lcom/samsung/android/goodlock/terrace/view/EmoticonPicker;Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
    ...
    new-instance v1, Lc/d/a/a/a0/g;

    invoke-direct {v1, p0, p2, p3, p1}, Lc/d/a/a/a0/g;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;JLcom/samsung/android/goodlock/terrace/dto/EmoticonRequest;)V
...
.method public static final postEmoticon$lambda-12$lambda-10(Lcom/samsung/android/goodlock/terrace/view/EmoticonPicker;Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
    .locals 1
    ...
    invoke-virtual {p1}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->getTip()Lcom/samsung/android/goodlock/terrace/dto/Tip;

    move-result-object v0

    invoke-virtual {v0}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getEmoticonList()Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getMyEmoticons()Ljava/util/ArrayList;
...
.method public static final postEmoticon$lambda-12$lambda-11(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;JLcom/samsung/android/goodlock/terrace/dto/EmoticonRequest;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->postEmoticon(JLcom/samsung/android/goodlock/terrace/dto/EmoticonRequest;)V
...
.method private final share()V
    ...
    iget-wide v1, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->id:J
...
.method private final updateUI(Lcom/samsung/android/goodlock/terrace/dto/Tip;)V
    .locals 6
    ...
    invoke-virtual {v0}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getMyEmoticons()Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getTitle()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getProduct()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getAuthor()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getCreatedAt()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getPin()Z
    ...
    invoke-virtual {p1}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getContent()Ljava/lang/String;
    ...
    new-instance v1, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$updateUI$1;

    invoke-direct {v1, p0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity$updateUI$1;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
    ...
    new-instance p1, Lc/d/a/a/a0/f;

    invoke-direct {p1, p0}, Lc/d/a/a/a0/f;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
...
.method public static final updateUI$lambda-4(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;Ljava/lang/String;)V
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/samsung/android/goodlock/terrace/dto/Tip;->getId()J

    move-result-wide v0

    invoke-direct {p0, p1, v0, v1}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->handleEmoticon(Ljava/lang/String;J)V
...
.method public final getGson()Lc/c/b/e;
    ...
    iget-object v0, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->gson:Lc/c/b/e;

    return-object v0
.end method

.method public final getTip()Lcom/samsung/android/goodlock/terrace/dto/Tip;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->tip:Lcom/samsung/android/goodlock/terrace/dto/Tip;
...
.method public onBackPressed()V
    ...
    iget-object v1, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->gson:Lc/c/b/e;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->initToolbarAndStatusBar()V

    invoke-direct {p0, p1}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->handleIntent(Landroid/os/Bundle;)Z

    sget-object p1, Lcom/samsung/android/goodlock/terrace/AccountUtil;->INSTANCE:Lcom/samsung/android/goodlock/terrace/AccountUtil;

    new-instance v0, Lc/d/a/a/a0/n1;

    invoke-direct {v0, p0}, Lc/d/a/a/a0/n1;-><init>(Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;)V
    ...
    iget-wide v0, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->id:J
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->onBackPressed()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->share()V
...
.method public final setTip(Lcom/samsung/android/goodlock/terrace/dto/Tip;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/samsung/android/goodlock/terrace/TipsDetailActivity;->tip:Lcom/samsung/android/goodlock/terrace/dto/Tip;
