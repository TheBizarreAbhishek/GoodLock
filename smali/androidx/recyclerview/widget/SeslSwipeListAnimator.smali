...
# static fields
.field public static final TAG:Ljava/lang/String; = "SeslSwipeListAnimator"


# instance fields
.field public final DEFAULT_DRAWABLE_PADDING:I

.field public final DEFAULT_LEFT_COLOR:I

.field public final DEFAULT_RIGHT_COLOR:I

.field public final DEFAULT_TEXT_COLOR:I

.field public final DEFAULT_TEXT_SIZE:I

.field public final DIRECTION_LTR:I

.field public final DIRECTION_RTL:I

.field public mBgLeftToRight:Landroid/graphics/Paint;

.field public mBgRightToLeft:Landroid/graphics/Paint;

.field public mContext:Landroid/content/Context;

.field public mDrawSwipeBitmapDrawable:Landroid/graphics/drawable/BitmapDrawable;

.field public mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;

.field public mSwipeBitmap:Landroid/graphics/Bitmap;

.field public mSwipeConfiguration:Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;

.field public mSwipeRect:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mTextPaint:Landroid/text/TextPaint;
...
.method private drawRectInto(Landroid/graphics/Canvas;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/drawable/Drawable;Landroid/graphics/Paint;ILjava/lang/String;FII)V
    .locals 9
    ...
    iget-object v1, v7, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mTextPaint:Landroid/text/TextPaint;

    move v2, p6

    invoke-virtual {v1, p6}, Landroid/text/TextPaint;->setAlpha(I)V
    ...
    :cond_0
    iget-object v2, v7, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mTextPaint:Landroid/text/TextPaint;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->drawSwipeText(Landroid/graphics/Canvas;Landroid/text/TextPaint;Ljava/lang/String;ILandroid/graphics/Rect;I)V
...
.method private drawRectToBitmapCanvas(Landroid/view/View;FF)Landroid/graphics/Canvas;
    ...
    iget-object v3, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object v6, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mSwipeRect:Landroid/graphics/Rect;

    iget-object v2, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mSwipeBitmap:Landroid/graphics/Bitmap;
    ...
    iput-object v2, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mSwipeBitmap:Landroid/graphics/Bitmap;
    ...
    iget-object v0, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mSwipeConfiguration:Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;
    ...
    iget-object v4, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mSwipeConfiguration:Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;

    iget v4, v4, Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;->drawablePadding:I

    add-int/2addr v2, v4

    invoke-direct {v3, v4, v12, v2, v0}, Landroid/graphics/Rect;-><init>(IIII)V

    sub-int v0, v14, v0

    div-int/2addr v0, v1

    invoke-virtual {v3, v12, v0}, Landroid/graphics/Rect;->offset(II)V
    ...
    invoke-direct {v2, v12, v12, v8, v14}, Landroid/graphics/Rect;-><init>(IIII)V

    iget-object v5, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mBgLeftToRight:Landroid/graphics/Paint;
    ...
    invoke-direct/range {v0 .. v10}, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->drawRectInto(Landroid/graphics/Canvas;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/drawable/Drawable;Landroid/graphics/Paint;ILjava/lang/String;FII)V

    new-instance v2, Landroid/graphics/Rect;

    const/4 v0, 0x0

    invoke-direct {v2, v12, v0, v13, v14}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    iget-object v12, v0, Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;->drawableRightToLeft:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mSwipeConfiguration:Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;
    ...
    invoke-direct {v0, v13, v7, v13, v7}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v3, v10, v7, v13, v14}, Landroid/graphics/Rect;-><init>(IIII)V

    iget-object v5, v11, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mBgRightToLeft:Landroid/graphics/Paint;
    ...
    invoke-direct {v2, v0, v0, v12, v14}, Landroid/graphics/Rect;-><init>(IIII)V
...
.method private drawSwipeText(Landroid/graphics/Canvas;Landroid/text/TextPaint;Ljava/lang/String;ILandroid/graphics/Rect;I)V
    .locals 5
    ...
    iget v0, v0, Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;->drawablePadding:I
    ...
    iget v1, v1, Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;->drawablePadding:I
    ...
    invoke-static {p3, p2, p5, p6}, Landroid/text/TextUtils;->ellipsize(Ljava/lang/CharSequence;Landroid/text/TextPaint;FLandroid/text/TextUtils$TruncateAt;)Ljava/lang/CharSequence;
...
.method public setSwipeConfiguration(Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;)V
    ...
    iput-object p1, p0, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mTextPaint:Landroid/text/TextPaint;

    iget-object v0, p0, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mSwipeConfiguration:Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;

    iget v0, v0, Landroidx/recyclerview/widget/SeslSwipeListAnimator$SwipeConfiguration;->textColor:I

    invoke-virtual {p1, v0}, Landroid/text/TextPaint;->setColor(I)V

    iget-object p1, p0, Landroidx/recyclerview/widget/SeslSwipeListAnimator;->mTextPaint:Landroid/text/TextPaint;
